  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 transform h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar w-64 lg:w-20 lg:sidebar-expanded:!w-64 2xl:!w-64 shrink-0 bg-slate-50 p-4 transition-all duration-200 ease-in-out ${sidebarOpen ? 'translate-x-0' : '-translate-x-64'}`}
      >
          ...
          <div>
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-md mb-0.5 last:mb-0 ${pathname === '/' && 'bg-slate-900'}`}>
                <NavLink end to="/" className={`block text-slate-400 hover:text-slate-800 truncate transition duration-150 ${pathname === '/' && 'font-bold text-zinc-100 hover:text-zinc-50'}`}>
                  <div className="flex items-center">
                    <div viewBox="0 0 24 24">
                      <HiPresentationChartBar className={`text-2xl text-slate-400 ${pathname === '/' && 'text-green-500'}`} />
                    </div>
              ...
              {/* Transactions */}
              <li className={`px-3 py-2 rounded-md mb-0.5 last:mb-0 ${pathname === '/transactions' && 'bg-slate-900'}`}>
                <NavLink end to="/transactions" className={`block text-slate-400 hover:text-slate-800 truncate transition duration-150 ${pathname === '/transactions' && 'font-bold text-zinc-100 hover:text-zinc-50'}`}>
                  <div className="flex items-center">
                    <div viewBox="0 0 24 24">
                      <HiNewspaper className={`text-2xl text-slate-400 ${pathname === '/transactions' && 'text-green-500'}`} />
                    </div>
              ...
              <li className={`px-3 py-2 rounded-md mb-0.5 last:mb-0 ${pathname === '/fuel-inventory' && 'bg-slate-900'}`}>
                <NavLink end to="/fuel-inventory" className={`block text-slate-400 hover:text-slate-800 truncate transition duration-150 ${pathname === '/fuel-inventory' && 'font-bold text-zinc-100 hover:text-zinc-50'}`}>
                  <div className="flex items-center">
                    <div viewBox="0 0 24 24">
                      <HiFire className={`text-2xl text-slate-400 ${pathname === '/fuel-inventory' && 'text-green-500'}`} />
                    </div>
              ...
              <li className={`px-3 py-2 rounded-md mb-0.5 last:mb-0 ${pathname === '/event-viewer' && 'bg-slate-900'}`}>
                <NavLink end to="/event-viewer" className={`block text-slate-400 hover:text-slate-800 truncate transition duration-150 ${pathname === '/event-viewer' && 'font-bold text-zinc-100 hover:text-zinc-50'}`}>
                  <div className="flex items-center">
                    <div viewBox="0 0 24 24">
                      <HiMap className={`text-2xl text-slate-400 ${pathname === '/event-viewer' && 'text-green-500'}`} />
                    </div>
