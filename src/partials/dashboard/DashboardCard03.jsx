...
import { HiArrowSmDown, HiCubeTransparent } from 'react-icons/hi';
          ...
          <div className='flex'>
            <div className='flex items-start'>
              <div className='p-3 bg-yellow-100 rounded-xl'>
                <HiCubeTransparent className={`text-3xl text-yellow-500`} />
              </div>
            </div>
            <div className='flex items-center ml-4'>
              <div className='justify items-center'>
                <h2 className="text-xs font-semibold text-slate-600">Daily Consumption</h2>
